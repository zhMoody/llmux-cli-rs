...
export function GeminiSettingsPreview({
  currentEnv, previewEnv, currentSettings, previewSettings,
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {exists && <span className="text-xs text-muted-foreground font-mono">~/.gemini/</span>}
